...
export default class Runner extends Command {
    ...
    get #teacherAssignmentContent() {
        return new PayloadContent(this.#teacherAssignment, this.#teachersDataPath, this.#environmentPath, this.#schoolName);
    }
    ...
    #initProps(flags: { collectionPath: string; dataPath: string; env: string; envPath: string | undefined; schoolName: string; }) {
        ...
        this.#teacherAssignment = path.join(collectionPath, "teacher-assignment")
